...
true_hor = np.loadtxt('re_10K_horizontal.txt',skiprows=1)
true_ver = np.loadtxt('re_10K_vertical.txt',skiprows=1)

sim_hor005_1K = np.loadtxt('hor005_10K.csv',skiprows=1,delimiter=',')
sim_hor01_1K = np.loadtxt('hor01_10K.csv',skiprows=1,delimiter=',')
sim_hor05_1K = np.loadtxt('hor05_10K.csv',skiprows=1,delimiter=',')
sim_hor09_1K = np.loadtxt('hor09_10K.csv',skiprows=1,delimiter=',')
sim_hor095_1K = np.loadtxt('hor095_10K.csv',skiprows=1,delimiter=',')

sim_vert005_1K = np.loadtxt('vert005_10K.csv',skiprows=1,delimiter=',')
sim_vert01_1K = np.loadtxt('vert01_10K.csv',skiprows=1,delimiter=',')
sim_vert05_1K = np.loadtxt('vert05_10K.csv',skiprows=1,delimiter=',')
sim_vert09_1K = np.loadtxt('vert09_10K.csv',skiprows=1,delimiter=',')
sim_vert095_1K = np.loadtxt('vert095_10K.csv',skiprows=1,delimiter=',')
