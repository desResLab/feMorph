...
def write_problem(out_file_name):
  ...
  f.write('NODEDOF 3\n')  
  # Timestep
  f.write('TIMESTEP 1.0e-5 5000 50\n')
  f.close()
...
def write_prop(out_file_name):
 ...
 f.write('VMSPROPS 100.0 38461.53846 57692.307 4.0 0.0\n')
 f.close()
...
if __name__ == "__main__":
  ...
  wall_nodes_oulet                  = read_wall(outlet_file)
  ...
  write_dir(wall_nodes_oulet,out_file_name)
